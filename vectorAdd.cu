...
{
    /* COMPLETAR 5: Aquí debemos obtener el índice i del vector C que computa cada hilo según el índice de bloque y el hilo dentro del bloque en que está ubicado */; 
...
int main(int argc, char** argv)
{
    ...
    // Inicializamos los vectores de entrada con valores aleatorios (ver funci�n anexa al final de este fichero)
    RandomInit(h_A, N);
    RandomInit(h_B, N);
